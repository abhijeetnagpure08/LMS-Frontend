  ...
  return (
    <div className="h-16 dark:bg-[#020817] bg-white border-b dark:border-b-gray-800 border-b-gray-200 fixed top-0 left-0 right-0 duration-300 z-10">
      ...
      <div className="md:hidden flex items-center justify-between px-4 h-full">
        <Link><h1 className="font-extrabold text-2xl">Learnify</h1></Link>
    ...
    <Sheet>
      ...
      <SheetContent className="flex flex-col">
        <SheetHeader className="flex flex-row items-center justify-between mt-2">
          <SheetTitle><Link>Learnify</Link></SheetTitle>
          <DarkMode />
        </SheetHeader>
        ...
        {user?.role === "instructor" && (
          <SheetFooter>
            <SheetClose asChild>
              <Button type="submit"><Link to="/admin/dashboard">Dashboard</Link></Button>
            </SheetClose>
          </SheetFooter>
        )}
      </SheetContent>
